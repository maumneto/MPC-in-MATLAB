...
step3 = repmat(1200,60,1);     % 1000ms step
%step4 = repmat(1800,50,1);     % 1800ms step

r = vertcat(step1,step2,step3,step2,step1);     % Signal reference 1
%r2 = vertcat(step1,step2,step3,step4,step3,step2);     % Signal reference 1
