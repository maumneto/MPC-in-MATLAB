...
%transferFunction = tf({[-1397 2.379e04], 3.483e06, [-4.112e06 -3.035e05 -1.114e06 2.088e05]},{[1 21.31 12.6], [1 2.449e04], [1 3.141e04 3384 1.009e04 185.2]}); 
...
% Run the closed-loop simulation and plot results. (if put more steps, you need to modify the matrix number)
% Remember: possible steps number: 3 - 4 - 10 (only to up)
step1 = repmat(300,60,1);      % 300ms step
step2 = repmat(1000,60,1);      % 500ms step
step3 = repmat(1900,60,1);     % 1000ms step
%step4 = repmat(1800,50,1);     % 1800ms step

r = vertcat(step1,step2,step3,step2,step1);     % Signal reference 1
%r = vertcat(step1,step2,step3,step4,step3,step2);     % Signal reference 1
